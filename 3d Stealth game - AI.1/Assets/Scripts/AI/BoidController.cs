...
{
    public GameObject FlockCenterCube;
    ...
    void Start()
    {
        boids = new GameObject[flockSize]; // Creates an array of objects in flock
        for (int i = 0; i < flockSize; i++)
        {
            ...
            boid.GetComponent<Flocking>().SetController(gameObject);
            boids[i] = boid;
        }
    }
